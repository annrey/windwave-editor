        ...
        if let Some(ref mut bridge) = self.scene_bridge {
            let result = match tool_name {
                ...
                "update_component" | "set_transform" | "set_sprite" => {
                    ...
                    bridge
                        .update_component(entity_id, comp_type, props)
                ...
                Err(e) => {
                    ...
                    let _reflection =
                        self.reflection_engine
                            .generate_reflection(tool_name, &e, &classification);

                    if let Some(alt_strategy) = self
                        .reflection_engine
                        .generate_alternative_strategy(tool_name, &e, &classification)
                    {
                        eprintln!("[ReflectionEngine] Alternative suggested: {}", alt_strategy);
            ...
            format!(
                "Simulated: {} with params {:?} (no SceneBridge)",
